...
public class ExpenseController {
    ...
    public void exec(String taskId) {
        ...
        Task task = tq.taskId(taskId).singleResult();

        Objects.requireNonNull(task,"未找到对应任务");
    ...
    public void genProcessDiagram(HttpServletResponse httpServletResponse, String processId) throws Exception {
        ProcessInstance pi = runtimeService.createProcessInstanceQuery().processInstanceId(processId).orderByStartTime().desc().singleResult();
        ...
        InputStream in = diagramGenerator.generateJpgDiagram(bpmnModel,1.0,true);
